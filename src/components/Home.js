        ...
        <section>
            <div className=" w-full h-screen bg-[#f5f1ea] dark:bg-[#3a3131] flex justify-center items-center">
                    ...
                    (<div onClick={() => setTheme("dark")} className="fixed z-[999] top-0 right-0 m-8" ><svg className="cursor-pointer hover:scale-110 transition-all" width="50px" height="50px" viewBox="0 0 24 24" fill="[#f5f1ea]" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M8 22H16" stroke="#f5f1ea" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M5 19H19" stroke="#f5f1ea" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M2 16H22" stroke="#f5f1ea" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M10 6.34141C10.6256 6.12031 11.2987 6 12 6C15.3137 6 18 8.68629 18 12C18 13.5217 17.4335 14.911 16.5 15.9687H7.5C6.56645 14.911 6 13.5217 6 12C6 11.2987 6.12031 10.6256 6.34141 10" stroke="#f5f1ea" stroke-width="1.5" stroke-linecap="round"/>
                        <path d="M12 2V3" stroke="#f5f1ea" stroke-width="1.5" stroke-linecap="round"/>
                        <path d="M22 12L21 12" stroke="#f5f1ea" stroke-width="1.5" stroke-linecap="round"/>
                        <path d="M3 12L2 12" stroke="#f5f1ea" stroke-width="1.5" stroke-linecap="round"/>
                        <path d="M19.0708 4.92969L18.678 5.32252" stroke="#f5f1ea" stroke-width="1.5" stroke-linecap="round"/>
                        <path d="M5.32178 5.32227L4.92894 4.92943" stroke="#f5f1ea" stroke-width="1.5" stroke-linecap="round"/>
                        </svg>
                    </div>)} 
                    ...
                    <motion.td className="z-10 relative top-9 w-[45%]" colspan="2">
                        <motion.div initial={{ opacity: 0, y: 0, x:-250 }} animate={controls} className=" w-full flex items-center justify-evenly">
                            <a href="https://www.linkedin.com/in/joaogabrielpitol/" className="dark:fill-[#FECE54] dark:hover:fill-[#665C9F] fill-[#665C9F] hover:fill-[#FECE54] hover:scale-110 transition-all"target="_blank">
                                ...
                                <path fill-rule="evenodd"  d="M20 1C21.6569 1 23 2.34315 23 4V20C23 21.6569 21.6569 23 20 23H4C2.34315 23 1 21.6569 1 20V4C1 2.34315 2.34315 1 4 1H20ZM20 3C20.5523 3 21 3.44772 21 4V20C21 20.5523 20.5523 21 20 21H4C3.44772 21 3 20.5523 3 20V4C3 3.44772 3.44772 3 4 3H20Z"/>
                                </svg>
                            </a>
